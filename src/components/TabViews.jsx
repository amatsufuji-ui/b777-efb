...
// 2. 計算関数のインポート
import { formatNum, formatWeightDisplay, parseWeightInput, calculateTAS, calculateHeadingAndGS, generateTurnPoints, calculateWindComponentRow } from '../utils/flightCalc';
