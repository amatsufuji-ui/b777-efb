...
export const SPECIAL_PAX_DATA = [
  { code: "WCHC", label: "歩行障がい旅客", desc: "歩行不可。座席移動・緊急脱出に他人の援助が必要。", escort: "必要", seat: "非常口不可\n※付添者は隣席", limit: "一定の範囲に調整される\n※付添者なしの場合、B777は最大4名まで(超過分は脱出援助者(EE)が必要)" },
  { code: "WCHS", label: "歩行困難旅客", desc: "階段昇降が不可能な旅客。(アスリートS含む)", escort: "-", seat: "非常口不可", limit: "制限なし" },
  ...
  { code: "DPNA", label: "知的障がい旅客", desc: "緊急脱出が自身ではできず、他人の援助が必要。", escort: "必要\n(付添者1名に対し2名迄)", seat: "非常口不可\n※付添者は隣席", limit: "制限なし\n※幼児・小児同伴不可" },
  { code: "BLND", label: "視覚障がい旅客", desc: "目の不自由な旅客。\n盲導犬は付添者とみなし、1名に対し1頭まで同伴可。", escort: "単独可\n(付添者1名に対し2名迄)", seat: "非常口不可\n※付添者は隣席", limit: "制限なし\n※単独搭乗時(付添者なし)は制限あり" },
  { code: "DEAF", label: "聴覚障がい旅客", desc: "耳の不自由な旅客。\n聴導犬は1名に対し1頭まで同伴可。", escort: "-", seat: "非常口不可", limit: "制限なし" },
  { code: "EXMO", label: "妊婦", desc: "出産予定日より28日以内の旅客。", escort: "予定日14日以内は医師の同伴が必要", seat: "非常口不可", limit: "制限なし" },
  { code: "INFT\nINST", label: "幼児", desc: "生後8日以上2歳未満\n※INSTは座席を使用する幼児(SOC INFT)", escort: "必要(12歳以上)\n同伴者1名につき2名迄", seat: "非常口不可\n※酸素マスク数の制限あり", limit: "各装備座席数の20%以下" },
  { code: "CHLD\nUMNR", label: "小児 / 単独搭乗", desc: "2歳以上12歳未満 (UMNRは5〜12歳)", escort: "5歳未満は12歳以上の同伴必要\n※UMNRは単独搭乗", seat: "非常口不可", limit: "制限なし" },
  { code: "PRIS", label: "被疑者", desc: "逮捕・拘束され、厳重な護送が行われるべき者。", escort: "必要(護送員)\n[国内] 1名に対し2名以上等\n[国際] 1名につき3名", seat: "非常口不可\n※窓側等に指定", limit: "1機あたり3件以内\n合計3人以内" },
  { code: "DEPA\nDEPU", label: "出入国管理局拘留者", desc: "退去を命じられた外国人、あるいはその容疑者。\n(DEPA=警備官同行, DEPU=同行なし)", escort: "DEPAは入国警備官同行", seat: "非常口不可", limit: "[国内] 1便あたり10名以内\n[国際] 制限なし" },
